...
**Last Automated Check:** `2026-09-22 11:00 UTC` | **Overall Health:** 🟢 **Operational** (30/31 sources healthy, `96.8%`)

| Source | Type | Status | HTTP | Details | Freshness |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **The Astronomer's Telegram** | `RSS` | 🟢 OK | `200` | 10 entries | 10h ago |
| **NASA News** | `RSS` | 🟢 OK | `200` | 10 entries | 13h ago |
| **NASA Science** | `RSS` | 🟢 OK | `200` | 10 entries | 6h ago |
| **JPL News** | `RSS` | 🟢 OK | `200` | 100 entries | 17h ago |
| **NASA Artemis** | `RSS` | 🟢 OK | `200` | 10 entries | 617h ago |
| **NASA Space Station** | `RSS` | 🟢 OK | `200` | 10 entries | 15h ago |
| **ESA News** | `RSS` | 🟢 OK | `200` | 15 entries | 20h ago |
| **ESO** | `RSS` | 🟢 OK | `200` | 10 entries | 811h ago |
| **NRAO** | `RSS` | 🟢 OK | `200` | 10 entries | 1009h ago |
| **Royal Astronomical Society** | `RSS` | 🟢 OK | `200` | 10 entries | 503h ago |
| **Phys.org** | `RSS` | 🟢 OK | `200` | 30 entries | 3h ago |
| **Universe Today** | `RSS` | 🟢 OK | `200` | 20 entries | 7h ago |
| **EarthSky** | `RSS` | 🟢 OK | `200` | 10 entries | 3h ago |
| **Astronomy Magazine** | `RSS` | 🟢 OK | `200` | 10 entries | 2h ago |
| **ScienceDaily Astronomy** | `RSS` | 🟢 OK | `200` | 60 entries | 21h ago |
| **ScienceDaily Astrophysics** | `RSS` | 🟢 OK | `200` | 60 entries | 21h ago |
| **ScienceDaily Space** | `RSS` | 🟢 OK | `200` | 60 entries | 21h ago |
| **New Scientist Space** | `RSS` | 🔴 Fail | `-` | 0 entries | - |
| **AAS Nova** | `RSS` | 🟢 OK | `200` | 600 entries | 18h ago |
| **arXiv astro-ph Recent** | `RSS` | 🟢 OK | `200` | 242 entries | 6h ago |
| **SpaceNews** | `RSS` | 🟢 OK | `200` | 11 entries | 19h ago |
| **Centauri Dreams** | `RSS` | 🟢 OK | `200` | 10 entries | 138h ago |
| **Science News Space** | `RSS` | 🟢 OK | `200` | 20 entries | 18h ago |
| **Keck Observatory** | `RSS` | 🟢 OK | `200` | 10 entries | 87h ago |
| **SpaceDaily** | `RSS` | 🟢 OK | `200` | 10 entries | 1h ago |
| **The Space Review** | `RSS` | 🟢 OK | `200` | 702 entries | 190h ago |
